...
//dump($arParams);
//dump($arResult);
//print_preformatted($_SESSION);
//print_preformatted($arResult);
//print_preformatted($arParams);
CJSCore::Init();
?>
<?
...
<? } else { ?>
    <nav class="menu-block">
        <ul>
            ...
            <li>
            <a href="?logout=yes&sessid=<?=$_SESSION['fixed_session_id']?>"> <?=GetMessage('AUTH_LOGOUT_BUTTON')?>
            </a>
            </li>
        </ul>
    </nav>
